...
class InvestmentViewModel {
    ...
    var quantityText: String = "" // Alınan ya da satılan birim
    var unitPriceText: String = "" // O anki 1 birimin fiyatı
    var date: Date = Date()
    var note: String = ""
    ...
    func addInvestmentTransaction(context: ModelContext, assets: [InvestmentAsset]) {
        ...
        context.insert(transaction) // Yeni işlemi SwiftData'ya al
    ...
    /// Get P/L percentage for an asset
    ...
    func plPercentage(asset: InvestmentAsset, currentPrice: Double) -> Double {
        ...
        // (Güncel - Maliyet) / Maliyet x 100 Matematik işlemi
